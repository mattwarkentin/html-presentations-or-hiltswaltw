...
opaque_box(
  ...
  p(".red[Dr. Strangelove], is a .blue[1964 black comedy film] that satirizes the .dark-green[Cold War] fears of a .purple[nuclear conflict] between the .orange[Soviet Union] and the .dark-pink[United States]."),
  p(".red[HTML Presentations], are a .blue[2020 presentation tool] that solves the .dark-green[Grad Students'] fears of an .purple[internal conflict] between .orange[static presentations] and .dark-pink[dynamic web technologies].")
)
```
...
- `R Markdown` to the rescue
  + Combines the best of markdown-driven typesetting with the power of the `R` language
